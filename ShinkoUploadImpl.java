                    ...
                    if (cellYm!=null) {
                        ...
                        if (editAllFlg) {
                            ...
                            for (Map<String, Object> jyuchuCurrency : jyuchuCurrencyList) {
                                ...
                                boolean chkRateFlg = chkAmountError(rate, jyuchuRate, rowIdxRate, nengetsu);
                                ...
                                boolean chkSPFlg = chkAmountError(sp, jyuchuSp, rowIdxSP, nengetsu);
                                ...
                                if (chkRateFlg && chkSPFlg) {
                                    ...
                                    jyucyuSpData.put("dataKbn", "M");
                                    jyucyuSpData.put("syuekiYm", nengetsu.replaceAll("/", ""));
                            ...
                            boolean chkNetFlg = chkAmountError(net, jyuchuNet, rowIdxJyuchuNet, nengetsu);
                            ...
                            if (chkNetFlg) {
                                ...
                                jyucyuNetData.put("dataKbn", "M");
                                jyucyuNetData.put("syuekiYm", nengetsu.replaceAll("/", ""));
...
//                        }
    ...
    private boolean setJyuchuDataForUpd(Sheet sheet, int colIdx, String nengetsu, String ankenId, String dataKbn,
